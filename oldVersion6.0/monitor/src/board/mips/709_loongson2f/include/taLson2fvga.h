...
#ifndef _TA_LSON2EVGA
#define _TA_LSON2EVGA
...
/**************************** 引用部分 *****************************************/
//#include <bspPubInfo.h>			/// 使用BSP公共信息
#include <sysTypes.h>			/// 使用系统定义的数据类型
...
#define VIDEO_COLS		1024//提交时需使用的分辨为1024*768  modify by mengxh
#define VIDEO_ROWS		768//480

#define VIDEO_VISIBLE_COLS	VIDEO_COLS
#define VIDEO_VISIBLE_ROWS	VIDEO_ROWS
...
#define VIDEO_VISIBLE_COLS	1024
#define VIDEO_VISIBLE_ROWS	768
...
#define CONSOLE_COLS		VIDEO_COLS
...
#endif
/**************************RADEON*******************************/
static unsigned long mmbase = 0x40000000; //0xb4000000; by mengxh 716 base addr
//static unsigned long iobase = 0xbfd0a100;
