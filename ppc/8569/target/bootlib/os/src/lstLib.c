...
/*
 * Copyright (c) 1982-1987, 1991-1993, 1995, 1998, 2001, 2003-2004, 2009, 2010
...
--------------------
02e,17feb10,pch  small footprint
02d,13mar09,jpb  Updated for LP64 support
02c,09nov04,job  Docs update
02b,18aug03,bpn  Added lstFree2() in order to specified the free function.
...
* It does not free the deleted node.
*
* RETURNS: N/A
*/
...
* function <freeFunc>.  The supplied routine should be declared as follows:
* \cs
*     void freeFunc
*         (
