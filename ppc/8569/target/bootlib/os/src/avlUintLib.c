...
/* 
 * Copyright (c) 2003-2004, 2009-2010, 2012, 2013 Wind River Systems, Inc. 
 *
...
--------------------
01h,09aug13,krz  Fixing Coverity issues.
01g,01feb12,pcs  Update the copyright information.
01f,26jan10,pcs  fix issue in avlUintTreeWalk.
01e,02apr09,pcs  Updated to add support for the LP64 data model.
01e,20apr09,jpb  Updated for LP64 support.
01d,04jun04,zl   avoid referencing node after inorder walk
01c,21apr04,rae  fix SuccessorGet and PredecessorGet (SPR #94339)
01b,04dec03,zl   cleared compiler warnings.
01a,02dec03,zl   created based on avlLib.c.
*/
...
STATUS avlUintInsert
    (
    AVLU_TREE *	 pRoot,		/* pointer to the root node ptr */
    ...
    *ppNode = pNewNode;
    ...
    avlUintRebalance (ancestor, ancestorCount);
...
AVLU_NODE * avlUintDelete
    (
    AVLU_TREE *	 pRoot,		/* pointer to the root node pointer */
...
* callbacks. Whenever a callback routine returns ERROR, avlUintTreeWalk()
