...
#  构建变量时从工具调用里增加输入输出
C_SRCS += \
$(PROJECT_PATH)/bootLib.c \
$(PROJECT_PATH)/bootParseLib.c 
...
%.o: $(PROJECT_PATH)/%.c
	...
	$(CC) -DCPU=PPC85XX -IC:/LambdaPRO1/lib/os -iquote -IC:/LambdaPRO1/lib/os -I./ -I../ -IC:/LambdaPRO/target/deltaos/include/include-boot -IC:/LambdaPRO/target/deltaos/config/include -IC:/LambdaPRO/target/deltaos/include/include-boot/net -IC:/LambdaPRO/target/deltaos/include/include-boot/vxworks/private -IC:/LambdaPRO/target/deltaos/include/include-boot/debug -IC:/LambdaPRO1/lib/os/src -IC:/LambdaPRO/target/deltaos/include/include-boot/arch/ppc -IC:/LambdaPRO/target/deltaos/include/include-boot/vxworks/wrn/coreip -IC:/LambdaPRO/target/deltaos/include/include-boot/vxworks/hwif -IC:/LambdaPRO/target/deltaos/comps/src/src-boot -IC:/LambdaPRO/target/deltaos/src/src-boot -IC:/LambdaPRO/target/deltaos/include/include-boot/debug -IC:/LambdaPRO/target/deltaos/include/include-boot/debug/ppc -IC:/LambdaPRO/target/deltaos/include/include-boot/vxworks -IC:/LambdaPRO/target/deltaos/include/include-boot/vxworks/ugl -IC:/LambdaPRO/target/deltaos/include/include-boot/rtl -IC:/LambdaPRO/target/deltaos/include/include-boot/DeltaCore ${OTHER_OPTION} -D${ARCH} ${CFLAGS}  -O0 -g -Wall -c -mfloat-gprs=double -mspe=yes -mabi=spe -fno-implicit-fp -o$@ $< && \
