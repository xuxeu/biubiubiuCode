...
export PROJECT_PATH:=C:/LambdaPRO1/lib/boot
export PROJECT_NAME:=boot
export CONFIG_NAME:=ppcGnu4.12
export CONFIG_PATH:=C:/LambdaPRO1/lib/boot/ppcGnu4.12
...
EXECUTABLES +=C:/LambdaPRO1/lib/boot/ppcGnu4.12/make/boot
TARGET_EXT +=elf
