...
typedef struct
{
    ...
    UINT32 (*WriteMemory)(UINT32 ctxId, UINT32 desAddr, const UINT8  *srcAddr, UINT32 size, T_DB_AccessMemoryAlign align);

    /* 读内存，该接口具备检查地址有效性，并能返回操作失败的详细原因 */
    UINT32 (*ReadMemory)(UINT32 ctxId, UINT32 readAddr, UINT8  *outBuf, UINT32  size, T_DB_AccessMemoryAlign align);

    /* 刷Cache */
    void (*FlushCache)(UINT32 ctxId, UINT32 addr, UINT32 len);
} T_DB_MemoryOper;
