...
/* IPI相关函数指针 */
typedef void (*TA_IPI_HANDLER_FUNC)(void);
typedef INT32 (*TA_IPI_INSTALL_HANDLER_FUNC)(INT32 ipiId, TA_IPI_HANDLER_FUNC ipiHandler,void *ipiArg);
typedef INT32 (*TA_IPI_EMIT_HANDLER_FUNC)(INT32 ipiId, UINT32 cpus);
typedef INT32 (*TA_IPI_ENABLE_FUNC)(INT32 ipiId);
/************************接口声明******************************/
