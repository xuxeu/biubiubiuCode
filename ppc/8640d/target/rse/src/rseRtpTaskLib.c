 ...
 *      任务个数
 */
static int resGetRtpTaskIdList(int rtpId, int rtpTaskIdList[])
{
	WIND_TCB *tid;
	int nTask = 0;
 ...
 *      None
 */
static void rseGetRtpTaskList(T_TA_Packet *packet,UINT32 *outSize)
{
    UINT8 *inbuf = NULL;
    UINT8 *outbuf = NULL;
    UINT8 *ptr = NULL;
    ...
    static UINT32 idx = 0;
    static INT32 taskIdList[RSE_MAX_RTP_TASKS] = {0};
