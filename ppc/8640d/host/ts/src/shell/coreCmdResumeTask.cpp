...
/* 解挂指定任务 */
int coreCmdProcess::m_resumeTask(string cmd)
{
    int ret = 0, len = 0;
    string cmdtemp = cmd;
    ...
    /* 组装查询指定任务命令包格式tr:xxxx */
    len = sprintf(pbuf, "tr:%s", cmdtemp.c_str());
