...
/* 通过任务ID获取实时进程ID */
#define	taRtpFromTaskGet(taskId) ((ulong_t)(taskTcb(taskId)->rtpId))
 ...
 */
UINT32 taRtpTaskAttach(TA_CTX_TYPE ctxType, ulong_t objId, UINT32 *pSid);
 ...
 *     TA_INVALID_RTP_ID：无效ID
 */
UINT32 taRtpSystemAttach(TA_CTX_TYPE ctxType, ulong_t objId, UINT32 *pSid);
