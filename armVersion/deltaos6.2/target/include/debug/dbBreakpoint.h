 ...
 */
T_TA_ReturnCode taDebugLookUpBP(UINT32 sessionID, UINT32 objID, ulong_t logicAddr, T_DB_Breakpoint **breakpointList);
 ...
 */
T_TA_ReturnCode taDebugRemoveBP(T_DB_Info *debugInfo, ulong_t logicAddr, T_DB_BpType breakpointType, T_DB_BpClass breakpointClass, ulong_t size);
