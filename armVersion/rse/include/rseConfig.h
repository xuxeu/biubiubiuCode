...
do\
{\
    l = ((((ulong_t)((UINT8)c[0]))<< 56) & 0xff00000000000000)|\
    ((((ulong_t)((UINT8)c[1]))<< 48)& 0x00ff000000000000)|\
	((((ulong_t)((UINT8)c[2]))<< 40)& 0x0000ff0000000000)|\
	((((ulong_t)((UINT8)c[3]))<< 32)& 0x000000ff00000000)|\
	((((ulong_t)((UINT8)c[4]))<< 24)& 0x00000000ff000000)|\
	((((ulong_t)((UINT8)c[5]))<< 16)& 0x0000000000ff0000)|\
	((((ulong_t)((UINT8)c[6]))<< 8) & 0x000000000000ff00)|\
    (((ulong_t)((UINT8)c[7])) & 0x00000000000000ff);\
} while(0)
