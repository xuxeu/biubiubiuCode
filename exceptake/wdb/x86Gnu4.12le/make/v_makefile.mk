...
export PROJECT_PATH:=F:/workspace/except/platform/workspace/wdb
export CONFIG_NAME:=x86Gnu4.12le
export CONFIG_PATH:=F:/workspace/except/platform/workspace/wdb/x86Gnu4.12le
...
EXECUTABLES +=F:/workspace/except/platform/workspace/wdb/x86Gnu4.12le/make/wdb
TARGET_EXT +=elf
