...
export PROJECT_PATH:=F:/workspace/except/platform/workspace/mdl
export CONFIG_NAME:=x86Gnu4.12le
export CONFIG_PATH:=F:/workspace/except/platform/workspace/mdl/x86Gnu4.12le
...
EXECUTABLES +=F:/workspace/except/platform/workspace/mdl/x86Gnu4.12le/make/mdl
TARGET_EXT +=elf
