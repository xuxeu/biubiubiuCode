...
export PROJECT_PATH:=F:/workspace/except/platform/workspace/rse
export CONFIG_NAME:=x86Gnu4.12le
export CONFIG_PATH:=F:/workspace/except/platform/workspace/rse/x86Gnu4.12le
...
EXECUTABLES +=F:/workspace/except/platform/workspace/rse/x86Gnu4.12le/make/rse
TARGET_EXT +=elf
