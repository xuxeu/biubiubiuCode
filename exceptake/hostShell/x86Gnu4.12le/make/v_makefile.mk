...
export PROJECT_PATH:=F:/workspace/except/platform/workspace/hostShell
export CONFIG_NAME:=x86Gnu4.12le
export CONFIG_PATH:=F:/workspace/except/platform/workspace/hostShell/x86Gnu4.12le
...
EXECUTABLES +=F:/workspace/except/platform/workspace/hostShell/x86Gnu4.12le/make/hostShell
TARGET_EXT +=elf
