...
{    
        ...
        //if (rtpEpId==0)
        //{
            taReportExceptionToHost(&taSDASessInfo, taTaskIdSelf(), context, buf, 0);
        //}
        //else
        //{
        //    taReportExceptionToHost(&taSDASessInfo, taTaskIdSelf(), context, buf, 3);
        //}
        ...
        /* 清空当前产生异常的线程ID */
        TA_SET_CUR_THREAD_ID(&(taSDASessInfo.sessInfo), 0);//if add
