...
export PROJECT_PATH:=F:/workspace/except/platform/workspace/sysDebug
export CONFIG_NAME:=x86Gnu4.12le
export CONFIG_PATH:=F:/workspace/except/platform/workspace/sysDebug/x86Gnu4.12le
...
EXECUTABLES +=F:/workspace/except/platform/workspace/sysDebug/x86Gnu4.12le/make/sysDebug
TARGET_EXT +=elf
