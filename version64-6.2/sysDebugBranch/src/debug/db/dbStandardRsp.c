...
ulong_t RspThreadId32To64(ulong_t threadId);
/************************外部声明*****************************/
...
#ifdef CONFIG_TA_LP64
	printf("RspThreadIsActive    threadId:%lx    0000\n",threadId);
	threadId = RspThreadId32To64(threadId);
	printf("RspThreadIsActive    threadId:%lx    1111\n",threadId);
#endif
...
int i = 0;
	...
	{
		if(threadId == (threadId&threadIdList[i]))
		{
