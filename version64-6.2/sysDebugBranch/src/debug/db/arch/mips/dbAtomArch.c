 ...
 */
T_TA_ReturnCode taDebugWriteSingleRegister(T_DB_ExceptionContext* context, UINT32 registerNum, const UINT8 *inBuf, UINT32 inLen)
{
    UINT64 value = 0;

    /* 参数有效性检查 */
    if ((registerNum >= REGISTER_SUM) || (0 == inLen) )
    {
