 ...
 *      无
 */
void taDirectFlushCache(ulong_t sessionID, ulong_t addr, UINT32 len);
 ...
 */
UINT32 taDirectReadMemory(ulong_t sessionID, ulong_t readAddr, UINT8 *outBuf, UINT32 size,T_DB_AccessMemoryAlign align);
 ...
 *      TA_INVALID_PARAM:非法的参数
 */
T_TA_ReturnCode taDirectWriteMemory(ulong_t sessionID, ulong_t dest, const UINT8 *src, UINT32 size,T_DB_AccessMemoryAlign align);
