...
//#endif
   ...
   // ini_taskcommand_service(proto);
   // ini_getmem_service( proto,bcg);
    ini_lock_service( proto,bcg);
    ini_getsem_service( proto,bcg);
    ini_cpushow_service(proto,bcg);
    ini_report_service(proto,bcg);
    ini_edr_service(proto,bcg);
