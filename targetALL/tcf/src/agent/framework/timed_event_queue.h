...
#include <framework/event_queue.h>  /* for struct event_node */
...
=======
 * Cancel pending event.  Can only be called from the dispatch
>>>>>>> 43c5b2a... TCF Agent: Fixed timed event queue cancellation
