...
#define SERVICE_RunControl      0/*(TARGET_UNIX || TARGET_VXWORKS || TARGET_WINDOWS)*/
#endif
#if !defined(SERVICE_Breakpoints)
#define SERVICE_Breakpoints    0/*(TARGET_UNIX || TARGET_VXWORKS || TARGET_WINDOWS)*/
#endif
#if !defined(SERVICE_Memory)
#define SERVICE_Memory          0/*(TARGET_UNIX || TARGET_VXWORKS || TARGET_WINDOWS)*/
#endif
#if !defined(SERVICE_Registers)
#define SERVICE_Registers       0/*(TARGET_UNIX || TARGET_VXWORKS || TARGET_WINDOWS)*/
#endif
...
#define SERVICE_MemoryMap      0/*(TARGET_UNIX || TARGET_VXWORKS || TARGET_WINDOWS)*/
#endif
#if !defined(SERVICE_StackTrace)
#define SERVICE_StackTrace      0/*(TARGET_UNIX || TARGET_VXWORKS || TARGET_WINDOWS)*/
#endif
...
#define SERVICE_Expressions     0/*(TARGET_UNIX || TARGET_VXWORKS || TARGET_WINDOWS)*/
#endif
#if !defined(SERVICE_Streams)
#define SERVICE_Streams        0/*(TARGET_UNIX || TARGET_VXWORKS || TARGET_WINDOWS)*/
#endif
...
#endif
#if !defined(SERVICE_DayTime)
#define SERVICE_DayTime			(TARGET_UNIX || TARGET_VXWORKS || TARGET_WINDOWS)
#endif
#if !defined(SERVICE_DayTimeTest)
#define SERVICE_DayTimeTest		(TARGET_UNIX || TARGET_VXWORKS || TARGET_WINDOWS)
#endif
