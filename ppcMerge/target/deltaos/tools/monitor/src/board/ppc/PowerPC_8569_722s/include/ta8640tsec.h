...
#define TSEC_BASE_ADDR     (CCSRBAR + 0x24000)
#define MDIO_BASE_ADDR    (CCSRBAR + 0x24000)
...
struct eth_device {
	...
	int  (*recv) (struct eth_device*, unsigned char *packet_buff);
...
#ifndef _miiphy_h_    //miiphy.h文件合并到该处
#define _miiphy_h_
